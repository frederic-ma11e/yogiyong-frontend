  ...
  render() {
    ...
    return (
      <div className="wholeRestaurantContainer">
        ...
        this.state.paymentInfo && ( // this.state.dataInfo 값이 있을때만 실행
              ...
              <div className="restaurantContainer">
                <div className="restaurant">
                  ...
                  <div className="restaurant__Info">
                    <img
                      classname="restaurant__Info__Img"
                      src={`https://www.yogiyo.co.kr/${this.state.restaurantInfo.logo_url}`}
                    />
                    <ul>
                      <li classname="star" starNum={this.starNum}>
                        {parseInt(this.state.restaurantInfo.review_avg) ==
                        "1" ? (
                        ...
                        <span>{this.state.restaurantInfo.review_avg}</span>
                      </li>
                      <li className="minPrice">
                        최소주문금액
                        <span>
                          {Math.floor(this.state.restaurantInfo.threshold)}원
                        </span>
                      </li>
                      <li className="payment">
                        결제{this.state.paymentInfo && paymentInfos}
                        <span className="paymentMethod paymentRed">
                          요기서결제
                        </span>
                      </li>
                      <li className="deliveryTime">
                        배달시간
                        <span>
                          {this.state.restaurantInfo.estimated_delivery_time}
                        </span>
                      </li>
                    </ul>
                  </div>
